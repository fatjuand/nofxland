...
export const catalog: VinylRecord[] = [
  ...
  { id: 47, band: 'Gustavo Cerati', album: 'Siempre Es Hoy', year: 2002, genre: 'Alternative Rock', hook: 'Electrónica y rock argentino en su punto', price: 100000, status: 'available' },
  ...
  { id: 77, band: 'My Chemical Romance', album: 'The Black Parade', year: 2006, genre: 'Alternative Rock', hook: 'Ópera punk que marcó una generación', price: 75000, status: 'available' },
  ...
  { id: 85, band: 'No Use for a Name', album: 'The Feel Good Record of the Year', year: 2008, genre: 'Punk Rock', hook: 'El último gran disco de Tony Sly', price: 75000, status: 'available' },
  { id: 86, band: 'No Use for a Name', album: 'Leche con Carne', year: 1995, genre: 'Punk Rock', hook: 'Punk melódico californiano en su mejor forma', price: 75000, status: 'available' },
  ...
  { id: 104, band: 'NOFX', album: 'Suffer', year: 1988, genre: 'Punk Rock', hook: '7" de punk veloz en su era más cruda', price: 25000, status: 'available' },
  { id: 105, band: 'NOFX', album: 'Lisa and Louise', year: 1990, genre: 'Punk Rock', hook: 'EP temprano con punk rápido y sucio', price: 25000, status: 'available' },
  ...
  { id: 110, band: 'Oxymoron', album: "Fuck the Nineties… Here's Our Noize", year: 1996, genre: 'Punk Rock', hook: 'Street punk alemán crudo y ruidoso', price: 50000, status: 'available' },
  ...
  { id: 117, band: 'Ramones', album: 'Leave Home', year: 1977, genre: 'Punk Rock', hook: 'Segundo disco de los inventores del punk', price: 50000, status: 'available' },
  ...
  { id: 123, band: 'Six Feet Under', album: 'Graveyard Classics II', year: 2004, genre: 'Death Metal', hook: 'Covers de rock hechos death metal', price: 75000, status: 'available' },
  ...
  { id: 134, band: 'Soundgarden', album: 'Black Hole Sun', year: 1994, genre: 'Grunge', hook: 'El single más icónico del grunge', price: 100000, status: 'available' },
